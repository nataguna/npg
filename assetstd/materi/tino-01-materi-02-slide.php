	...
	<section class="card">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<h4 class="h4 m-0 text-dark font-weight-bold">MATERI</h4> -->
					<p class="card-subtitle">Ikuti seluruh materi yang disajikan. Ulangi Jika Anda belum paham.</p>
				</div>
				<div class="col-sm-6 text-right">
					<img src="img/materi/inscinema-video.png" width="132" height="30" alt="InsCinema" />
				</div>
			</div>
		</header>
		<div class="card-body">
			...
			<div class="embed-responsive embed-responsive-4by3">
				<iframe class="embed-responsive-item" src="//www.slideshare.net/slideshow/embed_code/key/8cgISWKxjE4kkG"> </iframe> 
			</div>
			<!--
			<div class="col-lg-4">
		...
		<footer class="card-footer">
			<div class="row">
				<div class="col-md-12 text-right">
					<button type="button" class="mb-1 mt-1 mr-1 btn btn-xs btn-danger modal-dismiss">Tutup</button>
				</div>
			</div>
		</footer>
	</section>
