			<header class="header">
				<div class="logo-container">
					<a href="front" class="logo">
						<img src="../../assetc/img/logo.png" width="109" height="35" alt="Course 101" />
					</a>
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="assetstd/img/!sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="assetstd/img/!sample-user.jpg" alt="Joseph Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="assetstd/img/!sample-user.jpg" alt="Joe Junior" class="rounded-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="assetstd/img/istudents.jpg" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/!logged-user.jpg" />
							</figure>
