								...
								<div class="header-row pt-3">
									<nav class="header-nav-top">
										<ul class="nav nav-pills">
											...
											<li class="nav-item">
												<span class="ws-nowrap"><i class="fa fa-user"></i> <?php echo $this->session->userdata('nama'); ?></span>
											</li>
											<?php } ?>											
										</ul>
									</nav>
												...
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li><a class="dropdown-item" href="contactus.html">Tatacara Uji Kompetensi</a></li>
															<li><a class="dropdown-item" href="contactus.html">Pendaftaran Uji Kompetensi</a></li>
															<li><a class="dropdown-item" href="contactus.html">Jadwal Uji Kompetensi</a></li>
														</ul>
													</li>
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle" href="#">
														...
														<ul class="dropdown-menu">
															<li><a class="dropdown-item" href="news.html">InsCinema News</a></li>
															<li><a class="dropdown-item" href="gallery.html">Galeri InsCinema</a></li>
															<li><a class="dropdown-item" href="contactus.html">Announcement</a></li>
														</ul>
													</li>
<!-- Hyperlink profile -->
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															<li>
																<a class="dropdown-item" href="studentdetail">Profile</a>
															</li>
															<li>
																<a class="dropdown-item" href="studentcourse">Student Course</a>
															</li>	
															<li>
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															<li>
																<a class="dropdown-item" href="teacherdetail">Profile</a>
															</li>
															<li><a class="dropdown-item" href="teachercourse">Teacher Course</a></li>
															<li><a class="dropdown-item" href="logout">Logout</a></li>															
														</ul>
													</li>													
													<?php } elseif ($this->session->userdata('flag')=='1') { ?>
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle" href="#">
															<i class="fa fa-user"></i> User
														</a>
