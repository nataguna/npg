			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>List Peserta Uji Kompetensi</h2>
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>InsCinema LSP</span></li>
								<li><span>Peserta Uji Kompetensi</span></li>
							</ol>
							...
							<div class="col">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">List Peserta Uji Kompetensi</h2>
									</header>
									<div class="card-body">
										<table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
											...
											<?php
											$no=0;
											foreach ($uji_regis_data as $uji_regis)
											{
											?>
												<tr>
													<td width="80px"><?php echo ++$no ?></td>
													<td><?php echo $uji_regis->nama ?></td>
													<td><?php echo $uji_regis->email ?></td>
													<td><?php echo $uji_regis->no_telp ?></td>
													<td><?php echo $uji_regis->pilihan ?></td>
