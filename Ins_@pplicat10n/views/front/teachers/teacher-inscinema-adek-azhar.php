				...
				<div class="container">
					<div class="row">
							...
							<div class="owl-carousel owl-theme" data-plugin-options="{'items': 1, 'margin': 10}">
								<div>
									<span class="img-thumbnail d-block">
										<img alt="" height="300" class="img-fluid" src="../../img/mutiara/inscinema-adek.jpg">
									</span>
								</div>
								<!--
								<div>
						...
						<div class="col-lg-8">
							...
							<h2 class="mb-0">Adek <strong>Azhar</strong></h2>
				...
				<div class="container">
					<div class="row">
						<div class="col">
							...
							<h4 class="mt-5 mb-0 text-uppercase">Adek Azhar <strong>Courses</strong></h4>
