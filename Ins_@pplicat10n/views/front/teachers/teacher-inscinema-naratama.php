				...
				<div class="container">
					<div class="row">
							...
							<div class="owl-carousel owl-theme" data-plugin-options="{'items': 1, 'margin': 10}">
								...
								<div>
									<span class="img-thumbnail d-block">
										<img alt="naratama" height="300" class="img-fluid" src="../../img/mutiara/inscinema-naratama.jpg">
									</span>
								</div>
								<!--
								<div>
						...
						<div class="col-lg-8">
							...
							<h2 class="mb-0">Naratama <strong>Rukmananda</strong></h2>
							<h4 class="heading-primary">Marketing and Advertising Consultant and Contractor</h4>
<!--
							<hr class="solid">
				...
				<div class="container">
					<div class="row">
						<div class="col">
							...
							<h4 class="mt-5 mb-0 text-uppercase">Naratama <strong>Courses</strong></h4>
							<p>Pelatihan online yang diasuh oleh Mas Naratama Rukmananda.</p>
								
							<ul class="row portfolio-list">
								<li class="col-12 col-sm-6 col-lg-3">
									<div class="portfolio-item">
										<a href="course-inscinema-1.php">
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="../../img/projects/project.jpg" class="img-fluid" alt="">
													<span class="thumb-info-title">
														<span class="thumb-info-inner">Courses One</span>
														<span class="thumb-info-type">InsCinema</span>
													</span>
										...
										<a href="course-inscinema-1.php">
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													...
													<span class="thumb-info-title">
														<span class="thumb-info-inner">Courses Two</span>
														<span class="thumb-info-type">InsCinema</span>
													</span>
													<span class="thumb-info-action">
														<span class="thumb-info-action-icon"><i class="fa fa-link"></i></span>
										...
										<a href="course-inscinema-1.php">
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													...
													<span class="thumb-info-title">
														<span class="thumb-info-inner">Courses Three</span>
														<span class="thumb-info-type">InsCinema</span>
													</span>
													<span class="thumb-info-action">
														<span class="thumb-info-action-icon"><i class="fa fa-link"></i></span>
										...
										<a href="course-inscinema-1.php">
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													...
													<span class="thumb-info-title">
														<span class="thumb-info-inner">Courses Four</span>
														<span class="thumb-info-type">InsCinema</span>
													</span>
													<span class="thumb-info-action">
														<span class="thumb-info-action-icon"><i class="fa fa-link"></i></span>
