				...
				<div class="container">
					<div class="row">
							...
							<div class="owl-carousel owl-theme" data-plugin-options="{'items': 1, 'margin': 10}">
								<div>
									<span class="img-thumbnail d-block">
										<img alt="" height="300" class="img-fluid" src="../../img/mutiara/inscinema-almoenir.jpg">
									</span>
								</div>
								<!--
								<div>
									<span class="img-thumbnail d-block">
										<img alt="" height="300" class="img-fluid" src="../../img/mutiara/inscinema-almoenir2.jpg">
									</span>
								</div> -->
							</div>
						</div>
						<div class="col-lg-8">
							...
							<h2 class="mb-0">Al Moenir <strong>Rahmat</strong></h2>
<!--							<h4 class="heading-primary">sub-title</h4>
				...
				<div class="container">
					<div class="row">
						<div class="col">
							...
							<h4 class="mt-5 mb-0 text-uppercase">Al Moenir Rahmat <strong>Courses</strong></h4>
							<p>Pelatihan Online yang diasuh:</p>	
