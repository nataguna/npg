					...
					<div class="row">
						<div class="col">
							<section class="card card-admin">
								...
								<div class="card-body">
									<form action="regis-course-add" class="form-horizontal form-bordered" method="post">
										...
										<div class="form-group row">
											<label class="col-lg-3 control-label text-lg-right pt-2" for="inputPlaceholder">Course</label>
											<div class="col-lg-6">
												<select name="course" class="form-control mb-3">
													<option> --Pilih Course--</option>
													<option value="Fotografi Dasar"> Fotografi Dasar </option>
													<!--<option value="Produser"> Produser </option>
													<option value="Fotografer Muda"> Fotografer Muda </option>
													<option value="Fotografer Madya"> Fotografer Madya </option>
