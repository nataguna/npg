							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="home.html">
											<img alt="Porto" width="227" height="54" data-sticky-width="168" data-sticky-height="40" data-sticky-top="33" src="img/logo_inscinema.png">
										</a>
									</div>
								</div>
							</div>
...
<!-- Profile hyperlink -->
														<ul class="dropdown-menu">
<!--														
															<li><a class="dropdown-item" href="profiles/<?php // $username = $this->session->userdata('username') ?> ">Profile</a></li>
															<li><a class="dropdown-item" href="logout">Logout</a></li>		
-->	
															<li><?php echo anchor('detail/byID/'.$id = $this->session->userdata('id'),'Profile'); ?></li>
															<li><a class="dropdown-item" href="logout">Logout</a></li>											
														</ul>
													</li>
													<?php } else { ?>
